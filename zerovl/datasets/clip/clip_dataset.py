...
from zerovl.utils import ENV, logger
from zerovl.datasets.clip.utils import process_caption
from zerovl.transforms import build_transforms
from zerovl.datasets.builder import DATALOADER
...
def build_torch_shuffle_train_loader(cfg, names, mode, **kwargs):
    ...
    tokenizer = AutoTokenizer.from_pretrained(cfg.model.text_encoder.tag, cache_dir=f'/home/tiger/.cache/torch/hub/checkpoints/{cfg.model.text_encoder.tag}')
